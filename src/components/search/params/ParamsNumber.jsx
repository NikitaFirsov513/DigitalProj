...
export default function ParamsNumber() {
    ...
    return (
        ...
        <div ref={elem} className="search__params-elem search__params-elem--active">
            ...
            <div onClick={(e) => toogleActive()} ref={lable} className="search__params-lable search__params-lable--active">
                <p>Цена</p>
            ...
            <div className="search__params-number">
                <div className="search__params-number-block">
                    <p>
                        от
                    </p>
                    <input ref={min} onChange={e => toggleActiveParams({ type: "minPrice", value: Number(min.current.value) })} type="text" />
                </div>
                <div className="search__params-number-block">
                    <p>
                        до
                    </p>
                    <input ref={max} onChange={e => toggleActiveParams({ type: "maxPrice", value: Number(max.current.value) })} type="text" />
                </div>
            </div>
